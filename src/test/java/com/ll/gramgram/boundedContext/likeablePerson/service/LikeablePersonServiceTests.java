...
public class LikeablePersonServiceTests {
    ...
    void t001() throws Exception {
        ...
        // 인스타아이디가 insta_user3인 사람이 호감을 표시한 '좋아요' 목록
        ...
        for(LikeablePerson likeablePerson : fromLikeablePeople) {
            // 당연하게 그 특정화원(인스타아이디 insta_user3)이 좋아요의 호감표시자회원과 같은 사람이다.
            assertThat(instaMemberInstaUser3.getUsername()).isEqualTo(likeablePerson.getFromInstaMemberUsername());
        }
    }
